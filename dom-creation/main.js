...
function renderPokemon(pokemon) {
  ...
  pokemonCardTextDiv.appendChild(h2El);

  var h3El = document.createElement('h3');
  h3El.textContent = pokemon.number;
  pokemonCardTextDiv.appendChild(h3El);

  var pEl = document.createElement('p');
  pEl.textContent = pokemon.description;
  pokemonCardTextDiv.appendChild(pEl);
...
for (var i = 0; i < pokedex.length; i++) {
  var renderPokemonReturn = renderPokemon(pokedex[i]);
  rowSelector.appendChild(renderPokemonReturn);
}
